package com.dream.dreammod.block;
...
public class BlockDBed extends BlockHorizontal
{
    public static final PropertyEnum<BlockDBed.EnumPartType> PART = PropertyEnum.<BlockDBed.EnumPartType>create("part", BlockDBed.EnumPartType.class);
    ...
    public BlockDBed()
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(PART, BlockDBed.EnumPartType.FOOT).withProperty(OCCUPIED, Boolean.valueOf(false)));
    
        this.setCreativeTab(CreativeTabs.BUILDING_BLOCKS);
        
        this.setUnlocalizedName("d_bed_block");
        this.setRegistryName("d_bed_block_registry");
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            if (state.getValue(PART) != BlockDBed.EnumPartType.HEAD)
            {
    ...
    {
        return state.getValue(PART) == BlockDBed.EnumPartType.HEAD ? null : Items.BED;
    }
    ...
    {
        if (state.getValue(PART) == BlockDBed.EnumPartType.FOOT)
        {
    ...
    {
        if (player.capabilities.isCreativeMode && state.getValue(PART) == BlockDBed.EnumPartType.HEAD)
        {
            BlockPos blockpos = pos.offset(((EnumFacing)state.getValue(FACING)).getOpposite());
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return (meta & 8) > 0 ? this.getDefaultState().withProperty(PART, BlockDBed.EnumPartType.HEAD).withProperty(FACING, enumfacing).withProperty(OCCUPIED, Boolean.valueOf((meta & 4) > 0)) : this.getDefaultState().withProperty(PART, BlockDBed.EnumPartType.FOOT).withProperty(FACING, enumfacing);
    }
